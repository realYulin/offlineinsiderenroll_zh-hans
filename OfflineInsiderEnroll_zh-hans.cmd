...
cls
title OfflineInsiderEnroll 汉化版 v%scriptver%
echo.
echo 1 - 注册到 Dev 频道
echo 2 - 注册到 Beta 频道
...
:E_Build
echo =============================================================
echo 此脚本仅适用于 Windows 10 v1809 或更新版本，请更新系统版本
echo =============================================================
echo.
echo 请按任意键退出程序。
pause >nul
...
:E_Admin
echo =====================================================
echo 此脚本需要以管理员身份运行。请右键点击此脚本，然后点击“以管理员身份运行”
echo =====================================================
echo.
echo 请按任意键退出程序。
pause >nul
